/**
 * UTILS FOLDER - Response Utilities
 *
 * Purpose: Common response utilities for consistent API response formatting.
 * Provides type-safe response builders for success and error cases.
 *
 * Best Practices:
 * - Use for consistent API response structure
 * - Support dynamic metadata and pagination
